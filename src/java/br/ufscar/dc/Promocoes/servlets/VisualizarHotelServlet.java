...
@WebServlet(name = "VisualizarHotelServlet", urlPatterns = {"/VisualizarHotelServlet"})
public class VisualizarHotelServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (CNPJ == null) {
                todosHoteis = pdao.listarTodosHoteis();
            } 
